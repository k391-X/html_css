  ...
  return `
    <div class="flex flex-col lg:flex-row items-start gap-6">
      ...
      <div class="tag_02_right_chinh_sua_thong_tin py-4 px-2 w-full lg:w-2/3">
        ...
        <div class="flex flex-col sm:flex-row sm:items-stretch mt-6 sm:mt-8 border-b border-[#DCDCDC] pb-4 px-4">
          <!-- Ảnh sản phẩm -->
          <div class="w-[75px] max-w-[75px] max-h-[110px] sm:w-[100px] flex-shrink-0 mx-auto sm:mx-0">
            <img src="${Image208}" alt="demo" class="w-full h-auto rounded-lg custom-img-zoom" />
          </div>

          <!-- Thông tin sản phẩm -->
          <div class="mt-4 sm:mt-0 sm:ml-6 flex flex-col justify-between w-full">
            <div class="flex flex-col sm:flex-row sm:justify-between gap-2">
              <div class="text-[14px] font-[600] text-[#484554] sm:max-w-[300px] text-center sm:text-left line-clamp-3">
            ...
            <div class="flex flex-col sm:flex-row justify-between items-center sm:items-end mt-3 sm:mt-0 gap-2 sm:gap-0">
              ...
              <div class="max-w-[24px] max-h-[24px] cursor-pointer">
                <img src="${IconDelete}" alt="demo" class="w-full h-auto rounded-lg custom-img-zoom" />
              </div>
            </div>
          </div>
        </div>

        <div class="mt-4 ml-4 flex justify-center sm:justify-start">
      ...
      <!-- Khối thanh toán -->
      <div class="w-full lg:w-1/3 max-w-[300px] text-left mt-6 lg:mt-0 mx-auto lg:mx-0 bg-[#F9F9F9] p-4 tag_02_right_chinh_sua_thong_tin">
        <div class="border-b border-[#DCDCDC]">
          <div class="text-[18px] font-[700] text-[#0455A4] text-center lg:text-left pb-4 pt-1">
        ...
        <div class="border-b border-[#DCDCDC]">
          ...
          <div class="mt-3 text-[13px] font-[400] text-[#656565] mb-3">
