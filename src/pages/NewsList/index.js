        ...
        <div class="w-full lg:w-1/2 lg:pl-[35px] lg:pr-[150px] text-left flex justify-center">
          <div class="w-full max-w-[400px]">
            ...
            <div class="mt-[14px] sm:mt-[18px] text-[14px] sm:text-[16px] font-[500] text-[#717171]">
              Chưa có tài khoản? 
                <a href="#" class="text-link-register hover:underline">Đăng ký ngay</a>
            </div>
            ...
            <!-- Button + social -->
            <div class="mt-[24px] sm:mt-[30px] flex flex-col sm:flex-row items-center justify-between gap-4">
